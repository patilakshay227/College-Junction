...
<title>Dean Blog ( Electronics and Communication Department ) - College Junction</title>
</head>
<body>
	<%
		List<BlogPost> posts = BlogModel.fetchDeanPosts("Electronics and Communication");
		if (posts.size()>0) {
	%>
	<div>
		<%
